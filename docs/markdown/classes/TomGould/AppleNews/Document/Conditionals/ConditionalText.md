...
* Full name: `\TomGould\AppleNews\Document\Conditionals\ConditionalText`
...
```php
private array<string,mixed>|null $inlineTextStyles
```
...
| Parameter | Type                    | Description        |
|-----------|-------------------------|--------------------|
| `$styles` | **array<string,mixed>** | The inline styles. |
