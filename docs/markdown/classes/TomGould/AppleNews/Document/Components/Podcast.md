...
* Full name: `\TomGould\AppleNews\Document\Components\Podcast`
...
* https://developer.apple.com/documentation/apple_news/podcast_component
...
|-----------|------------|-------------------------|
| `$url`    | **string** | The Apple Podcasts URL. |
...
```php
public setImageURL(string $imageURL): $this
```
