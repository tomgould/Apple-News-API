...
* Full name: `\TomGould\AppleNews\Document\Components\Audio`
...
* https://developer.apple.com/documentation/apple_news/audio
...
|-----------|------------|---------------------------------------------|
| `$url`    | **string** | The URL to the audio file (MP3, AAC, etc.). |
