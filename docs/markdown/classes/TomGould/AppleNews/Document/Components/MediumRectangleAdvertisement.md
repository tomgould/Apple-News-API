...
* Full name: `\TomGould\AppleNews\Document\Components\MediumRectangleAdvertisement`
...
* https://developer.apple.com/documentation/apple_news/mediumrectangleadvertisement
