...
* Full name: `\TomGould\AppleNews\Document\Components\ARKit`
...
* https://developer.apple.com/documentation/apple_news/arkit
...
|-----------|------------|---------------------------|
| `$url`    | **string** | The URL to the USDZ file. |
...
| Parameter | Type       | Description        |
|-----------|------------|--------------------|
| `$url`    | **string** | The USDZ file URL. |

**Return Value:**

A new ARKit instance.
