...
* Full name: `\TomGould\AppleNews\Document\Components\BannerAdvertisement`
...
```php
public setBannerType(string $bannerType): $this
```
...
|---------------|------------|---------------------------------------------------------|
| `$bannerType` | **string** | The banner type ('standard', 'double_height', 'large'). |
