...
* https://developer.apple.com/documentation/applenewsformat/linkbutton
...
```php
public __construct(string $text, string $url): mixed
```
...
```php
public setTextStyle(string $textStyle): self
```
