...
* Full name: `\TomGould\AppleNews\Document\Components\FacebookPost`
...
* https://developer.apple.com/documentation/applenewsformat/facebookpost
...
|-----------|------------|-------------------------------|
| `$url`    | **string** | The URL of the Facebook post. |
