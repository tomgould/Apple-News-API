...
* Full name: `\TomGould\AppleNews\Document\Components\Video`
...
* https://developer.apple.com/documentation/applenewsformat/video
...
```php
public setStillURL(string $stillURL): self
```
