...
* Full name: `\TomGould\AppleNews\Document\Components\Divider`
...
```php
private array{color?: string, width?: int, style?: string}|null $stroke
```
...
```php
public setStroke(array<string,mixed> $stroke): self
```
