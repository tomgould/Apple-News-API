...
* Full name: `\TomGould\AppleNews\Document\Components\Instagram`
...
* https://developer.apple.com/documentation/applenewsformat/instagram
...
|-----------|------------|---------------------------------------|
| `$url`    | **string** | The direct URL to the Instagram post. |
