...
- [`AppleNewsException`](../Exception/AppleNewsException.md) If the API returns an error.
...
- [`AppleNewsException`](../Exception/AppleNewsException.md) If deletion fails.
...
- [`AuthenticationException`](../Exception/AuthenticationException.md) For 401/403 errors.
- [`AppleNewsException`](../Exception/AppleNewsException.md) For all other API errors.
